#!/usr/bin/env node
/**
 * Instrumented test v3: Uses fs.appendFileSync in worker for reliable logging
 */
...
try{
  ...
  if(Xt&&Xt.onHover&&Qt){
    ...
    _dbgFs.appendFileSync("${DBG_LOG}","[HOVER] SKIPPED Xt="+!!Xt+" onHover="+!!(Xt&&Xt.onHover)+" Qt="+!!Qt+"\\n\\n");
  }
}catch(_e){
...
async function main() {
    console.log('🔬 Worker-Instrumented Hover Test v3 (file logging)')
