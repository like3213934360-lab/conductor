/**
 * Antigravity Workflow Runtime — Reflexion 类型定义
 *
 * 架构优化: 将 Reflexion 相关接口从 persistence 提取到 shared,
 * 消除 runtime-core → persistence 的循环类型依赖。
 *
 ...
 * EpisodicMemory 接口契约
 *
 * 架构优化: antigravity-core 的 actor-loop 通过此接口与 persistence 层交互,
