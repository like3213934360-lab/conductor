/**
 * Conductor AGC — OpenTelemetry DAG Tracer
 *
 * 为 DAG 引擎提供标准化可观测性:
...
export const DagAttributes = {
  RUN_ID: 'conductor.dag.run_id',
  GRAPH_ID: 'conductor.dag.graph_id',
  NODE_ID: 'conductor.dag.node_id',
  NODE_NAME: 'conductor.dag.node_name',
  NODE_STATUS: 'conductor.dag.node_status',
  LANE: 'conductor.dag.lane',
  RISK_LEVEL: 'conductor.dag.risk_level',
  DREAD_SCORE: 'conductor.dag.dread_score',
  LOOP_ITERATION: 'conductor.dag.loop_iteration',
  EVENT_TYPE: 'conductor.event.type',
  EVENT_VERSION: 'conductor.event.version',
} as const
