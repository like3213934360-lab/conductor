...
const RoutingGuidePanel = ({ lang }) => {
    const T = {
        en: {
            title: 'Default Routing Recommendations',
            desc: 'Conductor Hub routes different task types to specific models by default based on benchmarking and cost-effectiveness. You can freely change these in the Models tab.',
        ...
        zh: {
            title: '默认路由推荐表',
            desc: '为了最大化性能并节约使用成本，Conductor Hub 默认采用以下模型推荐。这只是初始指导字典，您可以在「模型管理」中自由为任何模型分配任务。',
            colTask: '使用场景 / 任务属性',
            colModel: '推荐绑定模型',
            colReason: '核心竞争力入选理由',
            data: [
    ...
    return (react_1.default.createElement("div", { className: "animate-in", style: { maxWidth: '860px', paddingBottom: '20px' } },
        react_1.default.createElement("div", { style: { marginBottom: '20px' } },
            react_1.default.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' } },
                react_1.default.createElement(Icon_1.default, { name: "compass", size: 20, color: theme_1.colors.brand }),
        ...
        react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement("table", { style: {
                ...
                react_1.default.createElement("tbody", null, T.data.map((row, i) => (react_1.default.createElement("tr", { key: i, style: {
                    ...
                    react_1.default.createElement("td", { style: {
                        ...
                        react_1.default.createElement("span", { style: { display: 'inline-flex', alignItems: 'center', gap: '8px' } },
                            react_1.default.createElement(Icon_1.default, { name: row.icon, size: 14, color: theme_1.colors.brand }),
                            row.task)),
                    react_1.default.createElement("td", { style: {
...
exports.default = RoutingGuidePanel;
