...
describe('Antigravity daemon manifest endpoint', () => {
  ...
  it('reads and verifies the exported release attestation over local IPC', async () => {
    ...
    expect(attestation.document.signaturePolicyId).toBe('release-attestation-strict')
    ...
    expect(invariantReport.document.signaturePolicyId).toBe('invariant-report-strict')
    ...
    expect(verification.signaturePolicyId).toBe('release-attestation-strict')
    expect(releaseBundle.bundlePath).toMatch(/release-bundle\.json$/)
    expect(releaseBundle.document.signaturePolicyId).toBe('release-bundle-strict')
    ...
    expect(dossier.document.signaturePolicyId).toBe('release-dossier-strict')
