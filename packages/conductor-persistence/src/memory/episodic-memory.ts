...
import type {
  ...
  ReflexionPrompt,
  IEpisodicMemory,
} from '@anthropic/conductor-shared'

// 架构优化: 从 shared 重导出类型, 保持向后兼容
export type { EpisodicEntry, ReflexionEvaluation, ReflexionReflection, ReflexionPrompt } from '@anthropic/conductor-shared'
